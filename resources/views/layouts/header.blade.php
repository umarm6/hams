        ...
        <div class="hidden md:block w-full md:w-auto" id="menu">
            <nav
                ...
                <ul class="md:flex items-center">
                    <li><a class="py-2 inline-block text-{{$textColor}} md:hidden lg:block font-semibold" href="#">About Us</a></li>
                    <li class="md:ml-4"><a class="py-2 inline-block text-{{$textColor}} md:px-2 font-semibold"
                                           href="#">Treatments</a></li>
                    <li class="md:ml-4"><a class="py-2 inline-block text-{{$textColor}} md:px-2 font-semibold"
                                           href="#">Testimonials</a></li>
                    <li class="md:ml-4 md:hidden lg:block"><a class="py-2 inline-block text-{{$textColor}} md:px-2 font-semibold"
                                                              href="#">Blog</a></li>
