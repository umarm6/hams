    ...
    <div class="w-1/2 mx-auto p-4">
        ...
        <div class="bg-white shadow rounded p-4 space-y-4">
            <div>
                ...
                <p class="text-gray-600">{{ $prescription->patients->full_name }}</p>
            </div>
        ...
        <div class="mt-6">
            <a href="{{ route('prescriptions.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Back to List</a>
        </div>
    </div>
@endsection
