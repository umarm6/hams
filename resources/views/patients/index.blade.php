...
@section('content')
    <div class="max-w-7xl mx-auto p-4 mt-10">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('patients.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Add New</a>
        </div>
                        ...
                        <td class="px-4 py-2">{{ $record->email }}</td>
                         ...
                         <td class="px-4 py-2">{{ $record->date_of_birth }}</td>
                          <td class="px-4 py-2 space-x-2">
                            ...
                            <a href="{{ route('patients.edit', $record) }}" class="text-yellow-600 hover:underline">
                                 <i class="fa-edit fas"> </i>
                             </a>
                            <form action="{{ route('patients.destroy', $record) }}" method="POST" class="inline">
                                @csrf @method('DELETE')
